...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<DashboardFilters> }) {
  ...
  return <AppShell email={user.email} role={user.role}>
    <PageHeader eyebrow="Visión institucional" title="Dashboard 6MQ5" description="Seguimiento de análisis, criticidad y evolución operativa." action={<Link href="/analisis/nuevo" className="button button-primary"><Plus size={18} />Nuevo análisis</Link>} />
